# 91f68b8b-50e2-4ae9-b5e7-9c367cd5d4c1 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `login-vera-lila-neon.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `login-vera-lila-neon.html`
...
- A single self-contained `login-vera-lila-neon.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `login-vera-lila-neon.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `ChatGPT-Image-23-ago-2026_-03_32_00-p.m.png`
- `image-1.png`
- `image-2.png`
- `image.png`

## Coding checklist for AI tools
1. Inspect `login-vera-lila-neon.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
